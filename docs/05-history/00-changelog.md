...
- **ADR-008 작성**: 위 결정의 맥락과 근거, "Light ALM 철학과의 긴장 관계"에 대한 메모 포함 (문서 인계 zip의 한글 파일명 인코딩 문제로 1회 유실됐다가, 이미 커밋되어 있던 01-scope.md/02-competitive-reference.md/03~05 설계 내용을 근거로 재작성함)
